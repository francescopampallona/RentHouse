...
<body>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="/house/insert" method="post">
						...
						<label for="nation">Nation</label> <input class="form-control"
							type="text" name="nation" placeholder="Nation"> <label
							for="city">City</label> <input class="form-control" type="text"
							name="city" placeholder="City"> <label for="address">Address</label>
						<input class="form-control" type="text" name="address"
							placeholder="Address"> <label for="civicNumber">Civic
							number</label> <input class="form-control" type="number"
							name="civicNumber" placeholder="Civic number"> <label
							for="maxGuests">Max number of guests</label> <input
							class="form-control" type="number" name="maxGuests"
							placeholder="Max number of guests"> <label
							for="lowSeasonPrice">Low season daily price</label> <input
							class="form-control" type="number" min="0.00" max="1000000.00"
							step="0.01" name="lowSeasonPrice" placeholder="Low season price">

						<label for="mediumSeasonPrice">Medium season daily price</label> <input
							class="form-control" type="number" min="0.00" max="1000000.00"
							step="0.01" name="mediumSeasonPrice"
							placeholder="Medium season  price"> <label
							for="highSeasonPrice">High season daily price</label> <input
							class="form-control" type="number" min="0.00" max="1000000.00"
							step="0.01" name="highSeasonPrice"
							placeholder="High season price"> <input type="submit"
	...
	<table>
		...
		<tr>
			...
			%>
			<td>
				<form action="/reservation/<%=house.getId()%>/" method="GET">
					<input type="submit" value="RESERVATION MANAGEMENT">
				</form>
			</td>
			<!------------------------------------------------------------------------------------------ MODAL FOR DETAILS ------------------------------------------------------------------------------------------>
			<td>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="/house/update/<%=house.getId()%>" method="post">
									...
									<label for="nation">Nation</label> <input class="form-control"
										type="text" name="nation" placeholder="Nation"
										value="<%=house.getNation()%>"> <label for="city">City</label>
									<input class="form-control" type="text" name="city"
										placeholder="City" value="<%=house.getCity()%>"> <label
										for="address">Address</label> <input class="form-control"
										type="text" name="address" placeholder="Address"
										value="<%=house.getAddress()%>"> <label
										for="civicNumber">Civic number</label> <input
										class="form-control" type="number" name="civicNumber"
										placeholder="Civic number" value="<%=house.getCivicNumber()%>">

									<label for="maxGuests">Max number of guests</label> <input
										class="form-control" type="number" name="maxGuests"
										placeholder="Max number of guests"
										value="<%=house.getMaxGuests()%>"> <label
										for="lowSeasonPrice">Low season daily price</label> <input
										class="form-control" type="number" min="0.00" max="1000000.00"
										step="0.01" name="lowSeasonPrice"
										placeholder="Low season price"
										value="<%=house.getLowSeasonPrice()%>"> <label
										for="mediumSeasonPrice">Medium season daily price</label> <input
										class="form-control" type="number" min="0.00" max="1000000.00"
										step="0.01" name="mediumSeasonPrice"
										placeholder="Medium season  price"
										value="<%=house.getMediumSeasonPrice()%>"> <label
										for="highSeasonPrice">High season daily price</label> <input
										class="form-control" type="number" min="0.00" max="1000000.00"
										step="0.01" name="highSeasonPrice"
										placeholder="High season price"
										value="<%=house.getHighSeasonPrice()%>"> <input
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<form
									action="/rentAnnouncement/delete/<%=house.getAnnouncement().getId()%>"
									method="post">
